...
Route::middleware(['tozo.inbound', 'tozo.response'])
    ->defaults('tozo_profile', 'pos_api_inbound_from_tozo_app_api')
...
Route::middleware(['tozo.inbound', 'tozo.response'])
    ->defaults('tozo_profile', 'pos_api_inbound_from_app_admin_api')
...
Route::middleware(['tozo.inbound', 'tozo.response'])
    ->defaults('tozo_profile', 'pos_api_inbound_from_pmc_api')
