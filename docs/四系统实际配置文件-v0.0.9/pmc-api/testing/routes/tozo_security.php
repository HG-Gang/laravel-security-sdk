...
Route::middleware(['tozo.inbound', 'tozo.response'])
    ->defaults('tozo_profile', 'pmc_api_inbound_from_tozo_app_api')
...
Route::middleware(['tozo.inbound', 'tozo.response'])
    ->defaults('tozo_profile', 'pmc_api_inbound_from_app_admin_api')
...
Route::middleware(['tozo.inbound', 'tozo.response'])
    ->defaults('tozo_profile', 'pmc_api_inbound_from_pos_api')
